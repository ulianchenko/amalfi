...
const RoomInfoCard = () => {
  return (
    <div className='room-info__card'>
      <h3 className='room-info__card-title'>Room details</h3>
      <ul className='features-list'>
        ...
        <li className='features-list__item'>
          <div className='feature'>
            ...
            <div className='feature-content'>
              ...
              <div className='feature__subtitle'>Every bedroom has a window</div>
            </div>
          </div>
          <Divider className='feature-separator' />
        </li>
        <li className='features-list__item'>
          <div className='feature'>
            ...
            <div className='feature-content'>
              <div className='feature__title'>Cosiness</div>
